#!/bin/bash
# Optimized deploy script cho a-1754232882708 trên Nginx (Static HTML)
# Tạo bởi Theme Editor v2.0

set -e

echo "🚀 Bắt đầu deploy a-1754232882708..."

# Cấu hình
PROJECT_NAME="a-1754232882708"
DOMAIN="onghoangdohieu.com"
