...
const HeroBase = ({ theme, content, onContentUpdate, layout = 'classic' }: HeroBaseProps) => {
  ...
  const isCenteredVariant = layout === 'centered';
    ...
    >
      ...
      <div className="container mx-auto px-4 py-20 relative z-20">
        <div className={cn(
          ...
          isCenteredVariant ? "mx-auto max-w-5xl text-center" : "lg:grid-cols-2"
        )}>
          {/* Left Content */}
          <div className={cn("space-y-8", isCenteredVariant && "mx-auto max-w-4xl")}>
            <div className="space-y-4">
              ...
              <p
                className={cn("text-lg max-w-xl", isCenteredVariant && "mx-auto")}
                style={{
                  color: content.colorMode === 'custom' && content.textColor
            ...
            {/* Key Benefits */}
            <div className={cn("flex flex-wrap gap-4", isCenteredVariant && "justify-center")}>
            ...
            {/* CTAs */}
            <div className={cn("flex flex-col sm:flex-row gap-4", isCenteredVariant && "justify-center")}>
              <Button
                size="lg"
            ...
            {/* Trust Indicators */}
            <div className={cn("flex items-center space-x-8 pt-8", isCenteredVariant && "justify-center")}>
          ...
          {/* Right Image */}
          <div className={cn("relative", isCenteredVariant && "mx-auto w-full max-w-5xl")}>
            <Card className="overflow-hidden shadow-2xl border-0">
              {backgroundImageUrl ? (
                <div className={cn("relative w-full", isCenteredVariant ? "h-[420px]" : "h-[600px]")}>
                  <Image
