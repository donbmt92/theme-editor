      ...
      <Card className="p-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Select
              value={themeParams?.content?.testimonials?.titleSize || '4xl'}
              onValueChange={(value) => updateThemeParam(['content', 'testimonials', 'titleSize'], value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={themeParams?.content?.testimonials?.titleWeight || 'bold'}
              onValueChange={(value) => updateThemeParam(['content', 'testimonials', 'titleWeight'], value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={themeParams?.content?.testimonials?.titleFont || 'inter'}
              onValueChange={(value) => updateThemeParam(['content', 'testimonials', 'titleFont'], value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={themeParams?.content?.testimonials?.subtitleSize || 'xl'}
              onValueChange={(value) => updateThemeParam(['content', 'testimonials', 'subtitleSize'], value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={themeParams?.content?.testimonials?.subtitleWeight || 'normal'}
              onValueChange={(value) => updateThemeParam(['content', 'testimonials', 'subtitleWeight'], value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
          ...
          <div>
            ...
            <Select
              value={themeParams?.content?.testimonials?.subtitleFont || 'inter'}
              onValueChange={(value) => updateThemeParam(['content', 'testimonials', 'subtitleFont'], value)}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
