...
export default function middleware(req: NextRequest) {
    ...
    // Get hostname (e.g. toolbmt.com, shopgiay.com, localhost:3000)
    let hostname = req.headers.get("host") || "";

    // Handle localhost for local development
    // We can map localhost:3000 to toolbmt.com for testing the main site logic
